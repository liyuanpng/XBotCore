...
// #include <XBotCore-interfaces/XBotCommunicationHandler.h>
...
//     XBot::XBotCommunicationHandler::Ptr comhandler = std::make_shared<XBot::XBotCommunicationHandler>(path_to_config_file);
//
    XBot::AnyMapPtr anymap = std::make_shared<XBot::AnyMap>();
//     (*anymap)["IXBotJoint"] = boost::any(comhandler);
//     (*anymap)["IXBotFT"] = boost::any(comhandler);
