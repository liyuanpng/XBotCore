...
CommunicationInterfaceYARP::CommunicationInterfaceYARP(XBotInterface::Ptr robot): CommunicationInterface(robot)
{
...
bool CommunicationInterfaceYARP::open(yarp::os::Searchable& par)
{
return yarp::dev::DeviceDriver::open(par);
}

bool CommunicationInterfaceYARP::close()
{
