...
#include <XCM/advr_controller_joint_names.h>
...
namespace XBot {
    ...
    private:
        ...
        void callback(XCM::CommandAdvrConstPtr msg);

        bool service_callback(XCM::advr_controller_joint_namesRequest& req, XCM::advr_controller_joint_namesResponse& res);

        XCM::CommandAdvr _msg;
        ros::Publisher _pub;
        ros::Subscriber _sub;
