...
content_definition=$(cat include/fsm_state.h)
...
for var in "$@"
 do
  ...
  sed -i "/_STATE_DEFINITION_/ i\ $content_definition" include/fsm_definition.h
  ...
  sed -i -e "s/_STATE_PREFIX_/$var/g" include/fsm_definition.h  
...
sed -i -e "s/_STATE_DEFINITION_//g" include/fsm_definition.h  
